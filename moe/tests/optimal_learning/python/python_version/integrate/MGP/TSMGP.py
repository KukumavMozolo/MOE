...
class TestExpectedImprovement(GaussianProcessTestCase):
    ...
    def test_time_stationary_ego_plot(self):
        ...
        for dsimgma in [0.0]:
            ...
            location = '/home/maxweule/Documents/Thesis/results/TSMGP_runs_'+str(runs)+ '_pre_'+str(pre_samples) + '_iters_'+str(iterations)
    ...
    def get_ctrsinshift(self, alpha, time):
        ...
        #return numpy.exp(-(alpha - numpy.sin(time/2))
        #  ** 2) + numpy.sin(time)
