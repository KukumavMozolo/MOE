...
class TestExpectedImprovement(GaussianProcessTestCase):
    ...
    def time_stationary_ego(self, theta, repeated_domain, iterations, data, params, lbfgs_parameters, num_multistarts,threadid, N, sigma_2=0.0, plot = True):
        ...
        for i in range(iterations):
            ...
            cora_ei_eval = CoraExpectedImprovement(gaussian_process, idx, low, high, N, T=ts)
