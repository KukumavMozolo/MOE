...
GP_NEXT_POINTS_IEPI_ROUTE_NAME = 'gp_next_points_iepi'
GP_NEXT_POINTS_IEPI_ENDPOINT = '/gp/next_points/iepi'
GP_NEXT_POINTS_IEPI_MOE_ROUTE = MoeRoute(GP_NEXT_POINTS_IEPI_ROUTE_NAME, GP_NEXT_POINTS_IEPI_ENDPOINT)
GP_NEXT_POINTS_IEPI_PRETTY_ROUTE_NAME = 'gp_next_points_iepi_pretty'
GP_NEXT_POINTS_IEPI_PRETTY_ENDPOINT = '/gp/next_points/iepi/pretty'
GP_NEXT_POINTS_IEPI_PRETTY_MOE_ROUTE = MoeRoute(GP_NEXT_POINTS_IEPI_PRETTY_ROUTE_NAME, GP_NEXT_POINTS_IEPI_PRETTY_ENDPOINT)
GP_NEXT_POINTS_IEPI_OPTIMIZER_METHOD_NAME = 'multistart_expected_improvement_optimization'
...
GP_OPTIMAL_POINT_ROUTE_NAME = 'gp_optimal_point'
GP_OPTIMAL_POINT_ENDPOINT = '/gp/optimal_point'
GP_OPTIMAL_POINT_MOE_ROUTE = MoeRoute(GP_OPTIMAL_POINT_ROUTE_NAME, GP_OPTIMAL_POINT_ENDPOINT)
GP_OPTIMAL_POINT_PRETTY_ROUTE_NAME = 'gp_optimal_point_pretty'
GP_OPTIMAL_POINT_PRETTY_ENDPOINT = '/gp/optimal_point/pretty'
GP_OPTIMAL_POINT_PRETTY_MOE_ROUTE = MoeRoute(GP_OPTIMAL_POINT_PRETTY_ROUTE_NAME, GP_OPTIMAL_POINT_PRETTY_ENDPOINT)
GP_OPTIMAL_POINT_OPTIMIZER_METHOD_NAME = 'multistart_gp_optimization'
...
NEXT_POINTS_OPTIMIZER_METHOD_NAMES = [
        ...
        GP_NEXT_POINTS_IEPI_OPTIMIZER_METHOD_NAME
        ]
