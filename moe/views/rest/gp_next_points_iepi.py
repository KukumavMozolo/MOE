...
from moe.views.constant import GP_NEXT_POINTS_IEPI_ROUTE_NAME, GP_NEXT_POINTS_IEPI_PRETTY_ROUTE_NAME, GP_NEXT_POINTS_IEPI_OPTIMIZER_METHOD_NAME
from moe.views.gp_next_points_pretty_view import GpNextPointsPrettyView
from moe.views.pretty_view import PRETTY_RENDERER


class GpNextPointsIepi(GpNextPointsPrettyView):
    ...
    def gp_next_points_iepi_view(self):
