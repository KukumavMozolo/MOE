...
ENDPOINT_TO_DEFAULT_OPTIMIZER_TYPE = {
    ...
    (views_constant.GP_NEXT_POINTS_IEPI_ROUTE_NAME, MULTI_POINT_EI): L_BFGS_B_OPTIMIZER,
    (views_constant.GP_NEXT_POINTS_IEPI_ROUTE_NAME, SINGLE_POINT_EI): L_BFGS_B_OPTIMIZER,
...
OPTIMIZER_TYPE_AND_OBJECTIVE_TO_DEFAULT_PARAMETERS = {
    ...
    (L_BFGS_B_OPTIMIZER, views_constant.GP_NEXT_POINTS_IEPI_ROUTE_NAME, EI_COMPUTE_TYPE_ANALYTIC): _EI_MULTIPOINT_DEFAULT_OPTIMIZER,
    (L_BFGS_B_OPTIMIZER, views_constant.GP_OPTIMAL_POINT_ROUTE_NAME, EI_COMPUTE_TYPE_ANALYTIC): _EI_MULTIPOINT_DEFAULT_OPTIMIZER,
    ...
    (GRADIENT_DESCENT_OPTIMIZER, views_constant.GP_NEXT_POINTS_IEPI_ROUTE_NAME, EI_COMPUTE_TYPE_ANALYTIC): _EI_ANALYTIC_DEFAULT_OPTIMIZER,
    ...
    (GRADIENT_DESCENT_OPTIMIZER, views_constant.GP_NEXT_POINTS_IEPI_ROUTE_NAME, EI_COMPUTE_TYPE_MONTE_CARLO): DefaultOptimizerInfoTuple(
    DEFAULT_GRADIENT_DESCENT_MULTISTARTS_EI_MC,
    DEFAULT_GRADIENT_DESCENT_NUM_RANDOM_SAMPLES_EI_MC,
    DEFAULT_GRADIENT_DESCENT_PARAMETERS_EI_MC,
    ),
